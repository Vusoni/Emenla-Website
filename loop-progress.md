...
| P5 History record | The measured record: ruled track honest to the years, rolling serif year, cards in a band above the rule | 2 | FAIL r1 | PASS r1 | FAIL r1 | r1 brief: phone mid-gap left both cards clipped. r1 craft: a hairline and one lit card in 75 percent empty cream with 180px dead under the rule; readout said 1887 SEEN over an 1860 card; tick pitch reset at every node; pen read as a ninth node; figure panels shaped like the photo slot. Fixed in r2: card pinned over the reading point on phones with the rule sliding beneath; the big year moved into the space under the rule, cards up under the nav and larger; one global square-root scale from today; readout line says N years after it was first seen; pen hides under nodes; figures as ledger lines. |
